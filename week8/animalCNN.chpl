...
var net = new torch.Network(
    (
        new torch.Conv(3,16,kernelSize=11),
        new torch.Conv(16,16,kernelSize=5),
        // new torch.MaxPool(),
        new torch.Conv(16,32,kernelSize=5),
        // new torch.Conv(32,32,kernelSize=5),
        // new torch.MaxPool(),
        new torch.Conv(32,64,kernelSize=5),
        // new torch.Conv(64,64,kernelSize=3),
        new torch.Conv(64,128,kernelSize=5),
