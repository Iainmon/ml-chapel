...
mkdir -p speed_tests2

echo "data_size,num_seconds" > speed_tests2/trainer.py.csv
echo "data_size,num_seconds" > speed_tests2/trainer.chpl.csv
...
for data_size in 20 40 60 80 100 120 140 160 180 200; do
    ...
    time_output=$(python3.6 trainer.py $data_size | tail -n 1)
...
for data_size in 20 40 60 80 100 120 140 160 180 200; do
    ...
    # Run the command and capture its time
    time_output=$(./trainer --dataSize=$data_size | tail -n 1)
